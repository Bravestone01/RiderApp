  ...
  return (
    ...
    <SafeAreaView style={{flexGrow:1}} >
            ...
            <View style={styles.Container}>
                <View style={styles.innerContainer}>
                    <View style={styles.textView}>
                        <Text style={styles.textOne}>Enter your email address</Text>
                        <Text style={styles.textTwo}>Add your email to aid in account recovery</Text>

                    </View>

                    <View style={styles.inputView}>
                        <Text style={styles.inputText}>Email</Text>
                        <InputFied placeholder={"Exmple@gmail.com"} />
                    </View>
        ...
        <View style={styles.bottomInnerContainer}>
          ...
          <TouchableOpacity style={styles.nextButtonView} onPress={() => navigation.navigate('NameScreen')} >
